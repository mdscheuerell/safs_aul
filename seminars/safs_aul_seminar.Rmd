...
## 4. Data-poor benefit from data-rich
...
## .purple-text[Data]<sub><i>t</i></sub> = .orange-text[Loadings] × .blue-text[Trends]<sub><i>t</i></sub> + .under[Predictors]<sub><i>t</i></sub> + .red-text[error]<sub><i>t</i></sub>
