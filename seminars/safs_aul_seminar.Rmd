...
## .center.blue-text[Pre-process data to fit chosen model framework]

---

class: frimg
background-image: url(figs/rube.jpg)
...
## .center.gray-text[~~Pre-process data to fit chosen model framework~~]

# Better approach

## .center.blue-text[Choose model framework to match data]
