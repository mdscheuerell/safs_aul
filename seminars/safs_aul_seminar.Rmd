...
.right.blue-text[
## How do common spatial patterns change over time?
]

.gray-text.right[
### Thorson et al. (2015) *Meth* *Ecol* & *Evol*

### Thorson et al. (2016) *Global Ecol Biogeogr* & *Evol*
...
## 1) .orange-text[Supplementation] effect is hierarchical across popns
...
## 2) .red-text[Errors] include a common year effect
...
class: frimg
background-image: url(figs/rube2.jpg_large)
background-position: 50% 85%
background-size: 55%

# Common approach

## .center.blue-text[Pre-process raw data based upon chosen model]

---

# .gray-text[~~Common~~] Approach

## .center.gray-text[~~Pre-process raw data based upon chosen model~~]

## .center.blue-text[Choose model based upon raw data]

### .citation[Maunder & Punt (2013) _Fish Res_]
...
### .right.citation[Maunder & Punt (2013) _Fish Res_]
...
## .blue-text[Offspring] = f(.blue-text[Spawners], .orange-text[Hatchery fish], .green-text[Streamflows])
