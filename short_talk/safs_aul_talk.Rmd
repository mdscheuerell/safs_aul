...
# RESEARCH VISION, INTERESTS & APPROACHES
## Mark Scheuerell
...
# Need: Forecasts of future services
...
Spatial Factor Analysis .small[(Thorson et al. 2015)]

Dynamic Factor Analysis .small[(Ohlberger et al. 2016, Goertler et al. 2016)]

Joint Dynamic Species Distribution Models .small[(Thorson et al. 2016)]
...
Columbia River Chinook salmon .small[(Buhle et al. 2018)]

Skagit River steelhead .small[(Scheuerell et al. _in review_)]

Oregon Coast coho salmon .small[(Scheuerell et al. _in prep_)]
...
Spatial variation buffers juvenile salmon .small[(Thorson et al. 2013)]

Performance of fisheries across N Am .small[(Griffiths et al. 2014)]

Spatial heterogeneity in groundfishes .small[(Thorson et al. 2018)]
